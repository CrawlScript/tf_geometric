...
neighbor_sampler = RandomNeighborSampler(tfs.SparseMatrix(edge_index, shape=[6, 11]))
...
print(sampled_virtual_edge_index, sampled_virtual_edge_weight)
...
for _ in range(100):
    ...
    print("sampled_virtual_edge_weight: ", sampled_virtual_edge_weight)
