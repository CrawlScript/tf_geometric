...
from tf_geometric.nn.conv.graph_sage import mean_graph_sage, gcn_graph_sage, mean_pooling_graph_sage, \
    max_pooling_graph_sage, lstm_graph_sage
...
class MeanPoolingAggregator(MapReduceGNN):
    ...
    def call(self, inputs, cache=None, training=None, mask=None):
        ...
        return mean_pooling_graph_sage(x, edge_index, edge_weight, self.mlp_kernel, self.neighs_kernel,
                                       self.self_kernel, self.dropout, self.mlp_bias, self.bias, self.activation,
                                       self.normalize)
...
class MaxPoolingAggregator(MapReduceGNN):
    ...
    def call(self, inputs, cache=None, training=None, mask=None):
        ...
        return max_pooling_graph_sage(x, edge_index, edge_weight, self.mlp_kernel, self.neighs_kernel,
                                       self.self_kernel,
