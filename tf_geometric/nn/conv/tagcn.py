...
def gcn_norm_edge(edge_index, num_nodes, edge_weight=None, renorm=False, improved=False, cache=None):
...
def tagcn(x, edge_index, edge_weight, renorm=True, improved=False, cache=None):
    """
